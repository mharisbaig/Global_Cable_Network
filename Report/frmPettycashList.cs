...
{
    public partial class frmPettycashList : Form
    {
        ...
        private void frmPettycashList_Load(object sender, EventArgs e)
        {
           ...
           string qry = "select * from VoucherMaster where VCode=" + "'" +VoucherNo+"'";
