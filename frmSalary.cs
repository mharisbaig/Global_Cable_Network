...
namespace Global_Cable_Network
{
    public partial class frmSalary : Form
    {
        ...
        private void fillGrid()
        {
            ...
            string qry = "select VNo,Vdate,VAmount,VCode,Vdetail,subledgercode,LinkCode from VoucherMaster where SourceCode='10' ";
        ...
        private void FillSalary()
        {
            ...
            OleDbCommand cmd = new OleDbCommand();
            cmd.Connection = cn;
            cmd.CommandText = "SELECT * FROM LedgerSubHead where LedgerCode='2002' ORDER BY SubLedgerCode DESC ";
        ...
        private void SaveDetail()
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Source", "10");
                cmd.ExecuteNonQuery();
        ...
        private void SaveMaster()
        {
                ...
                cmd.Parameters.AddWithValue("@DRCR", "C");
                cmd.Parameters.AddWithValue("@SourceCode", "10");        // sourcecode 10 here represents staff salary vouchers
                cmd.Parameters.AddWithValue("@linkCode", txtEmployeeCode.Text.Trim());
        ...
        private void txtSalarydeduction_TextChanged(object sender, EventArgs e)
        {
