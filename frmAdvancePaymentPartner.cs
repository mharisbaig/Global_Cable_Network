...
{
    public partial class frmAdvancePaymentPartner : Form
    {
        public frmAdvancePaymentPartner()
        {
            InitializeComponent();
        }
        ...
        private void fillGrid()
        {
            ...
            string qry = "select VNo,Vdate,VAmount,VCode,Vdetail,subledgercode,LinkCode from VoucherMaster where SourceCode='8' ";
            // sourcecode 8 represents partners staff
        ...
        private void SaveMaster()
        {
                ...
                cmd.Parameters.AddWithValue("@SourceCode", "8");        // sourcecode 8 here represents partners advance vouchers
                cmd.Parameters.AddWithValue("@linkCode", txtEmployeeCode.Text.Trim());
        ...
        private void FillStaff()
        {
            ...
            OleDbCommand cmd = new OleDbCommand();
            cmd.Connection = cn;
            cmd.CommandText = "SELECT PName,pCode FROM Partners ORDER BY pCode DESC ";
        ...
        private void frmAdvancePaymentPartner_Load(object sender, EventArgs e)
        {
            fillVoucherType();
            FillAdvances();
            FillStaff();
